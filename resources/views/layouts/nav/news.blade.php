            ...
            <div class="px-4 py-3 flex">
                ...
                <div class="ml-4 flex  lg:ml-0">
                    <a href="{{ route('news.index') }}" class="flex items-center">
                        ...
                        <span class="text-gray-500 dark:text-gray-200 font-medium text-md">CryptoGainers News</span>
                    </a>
                </div>
            </div>
            {{-- nav --}}
                ...
                <div class="h-16 flex items-center">
                    ...
                    <div class="ml-4 flex  lg:ml-0">
                        <a href="{{ route('news.index') }}" class="flex items-center">
                            ...
                            <span class="text-gray-500 dark:text-gray-200 font-medium text-md">Crypto News</span>
                        </a>
                    </div>
                    {{-- nav menu --}}
                    ...
                    <div class="relative">
                        <div class="flex items-center ">
                            <svg xmlns="http://www.w3.org/2000/svg" class="lg:hidden h-5 w-5" fill="none"
