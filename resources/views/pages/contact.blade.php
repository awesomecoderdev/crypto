...
{{-- title --}}
@section('title', 'Contact Us : CryptoGainers')
...
@section('content')
    ...
    <section class="container my-8 hidden ">
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 border">
                <div class="bg-gray-900 md:col-span-4 p-10 text-white">
                    ...
                    <div class="flex items-center mt-5">
                        <svg class="h-6 mr-2 text-primary-600" fill="currentColor" version="1.1"
                    ...
                    <div class="flex items-center mt-5">
                        <svg class="h-6 mr-2 text-primary-600" fill="currentColor" version="1.1" id="Capa_1"
                ...
                <form class="md:col-span-8 p-10">
                    <div class="flex flex-wrap -mx-3 mb-6">
                        ...
                        <div class="w-full md:w-1/2 px-3">
                            ...
                            <input
                                class="appearance-none bg-transparent border-b border-primary-500 w-full text-gray-700 mr-3 p-4 leading-tight focus:outline-none focus:bg-gray-200"
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <textarea rows="10" class="appearance-none bg-transparent border-b border-primary-500 w-full text-gray-700 mr-3 p-4 focus:bg-gray-200 leading-tight focus:outline-none"
                                type="email" placeholder="jane@exp.com" aria-label="Full name">
