                    ...
                    <ul class="">
                        ...
                        <li class="text-left mb-10">
                            <div class="flex flex-row items-start mb-5">
                                <div
                                    class="hidden sm:flex items-center justify-center p-3 mr-3 rounded-full bg-primary-500 text-white border-4 border-white text-xl font-semibold">
                                ...
                                <div class="bg-gray-100 p-5 px-10 w-full flex items-center">
                                    <h4 class="text-md leading-6 font-medium text-gray-900">What could possibly be your
                                        first question?</h4>
                                </div>
                            </div>

                            <div class="flex flex-row items-start">
                                <div class="bg-primary-100 p-5 px-10 w-full flex items-center">
                                ...
                                <div
                                    class="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-primary-500 text-white border-4 border-white text-xl font-semibold">
                                    <svg height="25px" fill="white" version="1.1" id="Layer_1"
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        x="0px" y="0px" viewBox="0 0 295.238 295.238"
