                        ...
                        <div class="relative">
                            <div class="flex items-center ">
                                ...
                                <div class="relative inline-block " x-data="{ dropdown: false }"
                                    ...
                                    <button href="#" @click="dropdown = ! dropdown"
            ...
            <ul class="space-y-2">
                ...
                <li>
                    <a href="{{ route('admin.articles.index') }}"
                        class="group flex items-center lg:text-sm lg:leading-6 mb-4 {{ $page == 'admin.articles.index' ? $active : $inactive }} ">
                        <div
                ...
                @can('isSupperAdmin')
                    <li>
                        <a href="{{ route('admin.exchanges.index') }}"
                            class="group flex items-center lg:text-sm lg:leading-6 mb-4 {{ $page == 'admin.exchanges.index' ? $active : $inactive }} ">
                            <div
                    ...
                    <li>
                        <a href="{{ route('admin.coins.index') }}"
                            class="group flex items-center lg:text-sm lg:leading-6 mb-4 {{ $page == 'admin.coins.index' ? $active : $inactive }} ">
                            <div
                    ...
                    <li>
                        <a href="{{ route('admin.users.index') }}"
                            class="group flex items-center lg:text-sm lg:leading-6 mb-4 {{ $page == 'admin.users.index' ? $active : $inactive }} ">
                            <div
                                class="lg:mr-4 mr-1 justify-center rounded-md ring-1 ring-slate-900/5 shadow-sm group-hover:shadow group-hover:ring-slate-900/10 dark:ring-0 dark:shadow-none dark:group-hover:shadow-none dark:group-hover:highlight-white/10 group-hover:shadow-pink-200 dark:group-hover:bg-pink-500 dark:bg-slate-800 dark:highlight-white/5">
                                {{-- <svg class="h-5 w-5 m-1 text-pink-400 group-hover:text-pink-500/80 dark:group-hover:text-pink-300 dark:text-slate-400"
                                    fill="currentColor" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            ...
                            <span class="lg:block hidden">Users</span>
                        </a>
                    </li>
                @endcan
                <li>
