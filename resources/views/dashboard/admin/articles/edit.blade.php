...
@section('title', 'Edit Artilce | CryptoGainers')
    ...
    <div class="article">
        <form action="{{ route('admin.articles.update', $article->id) }}" method="POST" autocomplete="off">
            ...
            <div class="relative z-0 mb-6 w-full group">
                ...
                <a href="{{ route('news.show', $article->slug) }}" target="_blank" class="w-24 block ">
                    <div
                        ...
                        <span class="text-sm ml-1 dark:text-gray-50">
                            View
                        </span>
                    </div>
                </a>
